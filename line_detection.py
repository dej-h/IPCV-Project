    ...
    for i, line1 in enumerate(lines):
        ...
        for j in range(i + 1, len(lines)):
            ...
            if should_merge(merged_line, line2, angle_threshold, dis_threshold):
                ...
                merged_line['p1'] = (min(merged_line['p1'][0], line2['p1'][0]), min(merged_line['p1'][1], line2['p1'][1]))
                merged_line['p2'] = (max(merged_line['p2'][0], line2['p2'][0]), max(merged_line['p2'][1], line2['p2'][1]))
                visited.add(j)
